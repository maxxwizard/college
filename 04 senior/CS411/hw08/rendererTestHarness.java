  ...
  while(!done)
  {
   ...
   try
   {
    ...
    case 6:
     ...
     // "Yes" and "No" buttons, and player color label.
    ...
    case 7:
     ...
     // buttons must be visible to register hits
     ...
     System.out.println("Simulating a click outside all buttons -- No buttons should be hit");
     if (theRenderer.pixelInYesButton(1, 1) || theRenderer.pixelInNoButton(1,1) || theRenderer.pixelInResignButton(1,1))
     ...
     System.out.println("Simulating a click on the 'Yes' button -- The 'Yes' button should be hit");
     if (theRenderer.pixelInYesButton(201, 81))
       System.out.println("success!");
     else
       System.out.println("failure!");
     ...
     System.out.println("Simulating a click on the 'No' button -- The 'No' button should be hit");
     if (theRenderer.pixelInNoButton(301, 81))
       System.out.println("success!");
     else
       System.out.println("failure!");
     ...
     System.out.println("Simulating a click on the 'Resign' button -- The 'Resign' button should be hit");
     if (theRenderer.pixelInResignButton(431, 651))
       System.out.println("success!");
     else
       System.out.println("failure!");
